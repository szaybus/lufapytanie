...
--
-- Host: 127.0.0.1
-- Czas generowania: 26 Paź 2016, 14:49
...
(1, 'LUBISZ PSY?', 0, 1),
(2, 'ILE PARTNERÓW MIAŁAŚ?', 1, 1),
(3, 'ILE SPĘDZASZ CZASU NA GRANIU?', 0, 1),
(4, 'Czy rzygałeś po alkoholu?', 0, 0),
(5, 'Czy rzygałaś po alkoholu?', 0, 1),
(6, 'Czy wylądowałeś kiedyś z kimś w łóżku po alkoholu?', 2, 0),
...
(19, 'Kiedy pierwszy raz się masturbowałeś?', 2, 0),
(20, 'Czy używasz gadżetów erotycznych?', 2, 0),
(21, 'Czy używasz gadżetów erotycznych?', 2, 0),
...
(32, 'Czy miałeś fantazje ze zwierzęciem?', 2, 0),
...
(44, 'Czy byłeś kiedyś w seks shopie? Jeśli tak, to po co?', 2, 0),
(45, 'Czy byłaś kiedyś w seks shopie? Jeśli tak, to po co?', 2, 1),
(46, 'Czy uprawiałeś kiedyś seks dla korzyści materialnych?', 2, 0),
(47, 'Czy uprawiałaś kiedyś seks dla korzyści materialnych?', 2, 1),
(48, 'Jaka jest najbardziej zboczona rzecz, którą chciałbyś zrobić w łóżku?', 2, 0),
(49, 'Jaka jest najbardziej zboczona rzecz, którą chciałabyś zrobić w łóżku?', 2, 1),
...
--
ALTER TABLE `challenges`
  MODIFY `ID_CHALLENGE` int(255) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=44;
--
